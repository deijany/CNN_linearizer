#%%
# =================================================================
# Hammerstein Linearizer — Matrix Inversion with polynomial activation
# =================================================================
import numpy as np
...
L2                  = 2e-4    # L2 regularization strength (fixed)
NUMBER_SIMULATIONS  = 1       # Monte-Carlo repetitions inside the linearizer (Hammerstein model is deterministic, so only 1    simulation is needed)
CAUSAL_SYSTEM       = False   # True -> causal (introduces delay), False -> non-causal
...
linearizer = MatrixInversionLinearizer(
    X, V,
    BRANCH_NUMBER,
    [ActivationFunctions.polynomial],
    NUMBER_SIMULATIONS,
    L2,
    LINEARIZER_ORDER,
...
# =================================================================
if SAVE_RESULTS:
    base_filename = f"{simulation_path}/{folder_prefix}_ord_{LINEARIZER_ORDER}_H"
    results = {
